...
const ElementsOverview = () => {
    ...
    async function fetchNotes() {
      ...
      let data = elements;
      if(selectedGroup !== null) data = data.filter(el => el.group === selectedGroup);
      if(selectedApparatus !== null) data = data.filter(el => el.apparatus === selectedApparatus);
      if(description !== null) data = data.filter(el => el.description.includes(description));
